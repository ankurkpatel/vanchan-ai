...
export function PromptForm({
  ...
  return (
    ...
    >
      <div className="relative md:mb-3 sm:mb-2 md:rounded-md flex max-h-60 w-full grow flex-col overflow-hidden bg-background px-8 sm:rounded-md sm:border sm:px-12">
        <Tooltip>
